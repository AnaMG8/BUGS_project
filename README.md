...
* Natural area
* Rotational grazing area
* Mixed-species grazing area
...
The database comprises twelve complementary datasets.
...
| xii | Land-use polygons | 10 | – | Study area |
...
The processing workflow follows a transparent and reproducible structure from raw observations to final data products when applicable.
...
Morales-González, A., Jubber, W.R., Abegg, D., Behr, D.M., Bird, T.L., Deschodt, C., Fuller, A., Gómez-Peña, G., Graf, K.C., Haddad, C.R., Huber, S., Kamiński, M.J., Mbongiseni, M., Ozgul, A., Yáñez da Silva, C.  & Paniw, M. (2026). A fine-grained multitrophic biodiversity and environmental dataset for understanding global change impacts in drylands*. Zenodo. https://doi.org/10.5281/zenodo.18376602.
